...
const GoogleButton = ({ children, ...props }: { children: React.ReactNode } & React.ComponentProps<typeof Button>) => (
    <Button
      type="button"
      className="w-full gap-3 bg-white hover:bg-gray-50 text-gray-700 font-medium border border-gray-300 shadow-sm transition-all duration-200 hover:shadow-md py-6"
      {...props}
    >
        {children}
    </Button>
    ...
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black p-4 pt-24">
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="bg-black/50 backdrop-blur-sm border border-white/10 rounded-2xl p-8 shadow-2xl">
          ...
          <GoogleButton onClick={handleGoogleSignIn} disabled={isLoginBlocked}>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-black/50 px-2 text-white/50">O inicia sesión con email</span>
            </div>
          </div>
